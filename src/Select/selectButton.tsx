...
const { Flex, Text, useColorMode, createIcon, IconButton } = require("@chakra-ui/react");
...
const SelectButton = (props: ButtonProps) => {
  ...
  const getButtonIcon = ( getButtonIconProps: getButtonIconProps) => {
    if(getButtonIconProps.isReadOnly){
      return ( <IconButton aria-label='copy value' icon={<CopyIcon boxSize={iconSizeMap[size]} />} /> );
    }
